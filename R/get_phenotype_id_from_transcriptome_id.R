...
#'
#' @description Get the phenotype encoded by the genome of a digital organism that executes a specific transcriptome for a list of seeds used for starting the pseudo-random number generator (i.e., a set of environments).
#'
...
get_phenotype_id_from_transcriptome_id <- function(transcriptome_id, seed_id = FALSE, phenotype_binary = FALSE) {
  # Validate params
